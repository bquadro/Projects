...
function recalcl_full_filtr() {
		...
		var max_row_in_column = row_item + 4;  // допустимо больше среднего количества свойств в колонке
    ...
    row_html_group += '<div class="b_group_col b_group_col_0">';
		var coll_group = 0;
		$(".b_big_filtr .b_filter_group").each(function(i, e) {
		    ...
		    if( (dynamic_counter_in_column + filtr_count_in_group) <= max_row_in_column ) {
  		    dynamic_counter_in_column+=filtr_count_in_group;
					...
					coll_group++;
  		    row_html_group += '</div><div class="b_group_col b_group_col_' + coll_group + '">';
  		    dynamic_counter_in_column = filtr_count_in_group;
		    }
		    row_html_group += '<div class="b_filter_group">';
		    row_html_group += '<div class="b_filter_group_name">название группы</div>';
        ...
        $(".b_box", e).each(function() {
		    ...
		    row_html_group += '</div>';
		    row_html_group += '</div>';
        console.log(dynamic_counter_in_column);
		});
		row_html_group += '</div>';
		row_html_group += '</div>';
