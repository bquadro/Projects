						...
						if	($arItem["DELAY"]	==	"N"	&&	$arItem["CAN_BUY"]	==	"Y"):
										...
										<div class="order_block_main_info cf">
												...
												<div class="project_main_info_block cf">
														<div class="project_char">
																<?
																if	(strlen($arItem["DETAIL_PAGE_URL"])	>	0)
																		echo	"<a href=\"{$arItem["DETAIL_PAGE_URL"]}\" class=\"project_title\">";
																echo	strtoupper($arItem["PROPERTY_CODE_VALUE"])	.	" "	.	$arItem["NAME"];
																if	(strlen($arItem["DETAIL_PAGE_URL"])	>	0)
																		echo	"</a>";
																?>
																		...
																		<tbody>
																				<?	if	($arItem["OPTIONS"][1]):	?>
																						...
																						foreach	($arItem["OPTIONS"][1]	as	$option):	
																								...
																								?>
																								<tr class="first_row ordering_table_row <?= $option["IN_BASKET"]=="Y"?"ordering_table_row-checked":""?>">
																										<td class="td_check">
																												<div class="chechbox_container"></div>
																												<input type="hidden" class="checkbox" value="<?= $option["IN_BASKET"]=="Y"?"Y":"N"?>" name="options[<?=	$arItem["PRODUCT_ID"]	?>][<?=	$option["ID"]	?>]">
																										</td>
																										<td class="td_name">
																												<?
																												echo	$option["NAME"];
																												if	($option["DESCRIPTION"]	!=	""):
																														?><a href="#" class="td_info q" data-text="<?=	show_qtip($option["DESCRIPTION"],	$option["DESCRIPTION_TYPE"])	?>"></a><?
																												endif;
																												?>
																										</td>
																				...
																				<?	if	($arItem["OPTIONS"][2]):	?>
																						<tr>
																								<td colspan="3" class="td_title">Для вас могут быть разработаны:</td>
								...
								<td></td>
																				...
																				<tr class="tr_price">
																						...
																						<td class="td_price_value" id="price_options_<?=$arItem["PRODUCT_ID"]?>"><?=	catalog_price_format($opt_price+$arItem["PRICE"])	?></td>
																						<td></td>
																				</tr>
																		</tbody>
																</table>
