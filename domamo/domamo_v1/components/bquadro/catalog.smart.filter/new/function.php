...
<? 
  ...
  $max = isset($arItem["VALUES"]["MAX"]["HTML_VALUE"]) && $arItem["VALUES"]["MAX"]["HTML_VALUE"] != '' 
    ? 
...
?>
                    			...
                    			<div class="b_range_slide" 
                      			...
                      			data-rel="range_<?=$arParams["FILTER_NAME"]?>_<?=($arItem["PRICE"]?'P':'')?><?=$arItem["ID"]?>"
                        		id="range_<?=$arParams["FILTER_NAME"]?>_<?=($arItem["PRICE"]?'P':'')?><?=$arItem["ID"]?><?=$show_all?"_FULL":""?>"
                    			></div>
