...
?>
<div class="border_in_bottom cf">
<h3><?=strtoupper(GetMessage("SOA_TEMPL_PROP_INFO"))?></h3>
        ...
        ?>
            ...
            ?>
                <h4><a href="#" class="slide" onclick="fGetBuyerProps(this); return false;">
        ...
        <div id="sale_order_props" <?=($bHideProps && $_POST["showProps"] != "Y")?"style='display:none;'":''?>>
            ...
            ?>
                <div class="order_form_textarea"><label><?=GetMessage("SOA_TEMPL_SUM_COMMENTS")?></label>
                    <textarea rows="3" class="text" style="resize: vertical;" name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea>
            </div>
        </div>
    </div>
