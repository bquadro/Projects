            ...
            ?>
                    ...
                    foreach ($arSource as $arProperties)
                    {
                        ?>
                            ...
                            <div class="order_form_<?=$arProperties["TYPE"] == "TEXTAREA"?'textarea':($arProperties["TYPE"] == "LOCATION"?'select':'input');?>">
                                <?
                                ...
                                elseif ($arProperties["TYPE"] == "TEXT")
                                {
                                    ...
                                    <label><?=$arProperties["NAME"]?><?if ($arProperties["REQUIED_FORMATED"]=="Y"):?><span class="ico"></span><?endif;?></label>	
                                         <input style="<?=$style?>" class="text <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>req<?endif;?>" type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>">
