...
$MESS['SOA_TEMPL_PROP_INFO'] = "ИНФОРМАЦИЯ О ПОКУПАТЕЛЕ";
...
$MESS['SOA_TEMPL_ORDER_SUC1'] = "На ваш электронный почтовый ящик будет направлено подтверждение заказа. Наш менеджер свяжется с Вами в ближайшее время для уточнения деталей заказа.";
...
$MESS['SOA_TEMPL_NOADDR'] = "Выберите выше ближайший к Вам город, чтобы узнать стоимость и возможные способы доставки.";
$MESS['SOA_TEMPL_DELIVER'] = "ВАРИАНТЫ ДОСТАВКИ";
$MESS['SOA_TEMPL_PAYMENT'] = "СПОСОБ ОПЛАТЫ";
